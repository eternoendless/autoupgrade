...
require_once(__DIR__.'/AdminSelfTab.php');

require_once(__DIR__.'/classes/Upgrader.php');
...
require_once(__DIR__.'/classes/Tools14.php');

use PrestaShop\Module\AutoUpgrade\BackupFinder;
use PrestaShop\Module\AutoUpgrade\State;
use PrestaShop\Module\AutoUpgrade\UpgradeConfiguration;
...
class AdminSelfUpgrade extends AdminSelfTab
{
    ...
    public function getCheckCurrentPsConfig()
    {
        ...
        if (empty($allowed_array)) {
            ...
            $allowed_array = array(
                ...
                'root_writable' => $this->getRootWritable(),
                'admin_au_writable' => ConfigurationTest::test_dir($admin_dir.DIRECTORY_SEPARATOR.$this->autoupgradeDir, false, $report),
    ...
    /**
     * Return the path to the zip file containing PrestaShop.
     *
     * @return string
     */
    ...
    protected function _displayForm2($name, $fields, $tabname, $size, $icon)
    {
        $confValues = $this->getConfig();
        $required = false;
    ...
    private function _getJsErrorMsgs()
    {
        ...
        $ret = array(
            0 => $this->trans('Required field', array(), 'Modules.Autoupgrade.Admin'),
            1 => $this->trans('Too long!', array(), 'Modules.Autoupgrade.Admin'),
            2 => $this->trans('Fields are different!', array(), 'Modules.Autoupgrade.Admin'),
            3 => $this->trans('This email address is wrong!', array(), 'Modules.Autoupgrade.Admin'),
            4 => $this->trans('Impossible to send the email!', array(), 'Modules.Autoupgrade.Admin'),
            5 => $this->trans('Cannot create settings file, if /app/config/parameters.php exists, please give the public write permissions to this file, else please create a file named parameters.php in config directory.', array(), 'Modules.Autoupgrade.Admin'),
            6 => $this->trans('Cannot write settings file, please create a file named settings.inc.php in the "config" directory.', array(), 'Modules.Autoupgrade.Admin'),
            7 => $this->trans('Impossible to upload the file!', array(), 'Modules.Autoupgrade.Admin'),
            8 => $this->trans('Data integrity is not valided. Hack attempt?', array(), 'Modules.Autoupgrade.Admin'),
            9 => $this->trans('Impossible to read the content of a MySQL content file.', array(), 'Modules.Autoupgrade.Admin'),
            10 => $this->trans('Cannot access a MySQL content file.', array(), 'Modules.Autoupgrade.Admin'),
            11 => $this->trans('Error while inserting data in the database:', array(), 'Modules.Autoupgrade.Admin'),
            12 => $this->trans('The password is incorrect (must be alphanumeric string with at least 8 characters)', array(), 'Install'),
            14 => $this->trans('At least one table with same prefix was already found, please change your prefix or drop your database', array(), 'Install'),
            15 => $this->trans('This is not a valid file name.', array(), 'Modules.Autoupgrade.Admin'),
            16 => $this->trans('This is not a valid image file.', array(), 'Modules.Autoupgrade.Admin'),
            17 => $this->trans('Error while creating the /app/config/parameters.php file.', array(), 'Modules.Autoupgrade.Admin'),
            18 => $this->trans('Error:', array(), 'Modules.Autoupgrade.Admin'),
            19 => $this->trans('This PrestaShop database already exists. Please revalidate your authentication information to the database.', array(), 'Modules.Autoupgrade.Admin'),
            22 => $this->trans('An error occurred while resizing the picture.', array(), 'Modules.Autoupgrade.Admin'),
            23 => $this->trans('Database connection is available!', array(), 'Modules.Autoupgrade.Admin'),
            24 => $this->trans('Database Server is available but database is not found', array(), 'Modules.Autoupgrade.Admin'),
            25 => $this->trans('Database Server is not found. Please verify the login, password and server fields.', array(), 'Modules.Autoupgrade.Admin'),
            26 => $this->trans('An error occurred while sending email, please verify your parameters.', array(), 'Modules.Autoupgrade.Admin'),
            37 => $this->trans('Impossible to write the image /img/logo.jpg. If this image already exists, please delete it.', array(), 'Modules.Autoupgrade.Admin'),
            38 => $this->trans('The uploaded file exceeds the upload_max_filesize directive in php.ini', array(), 'Modules.Autoupgrade.Admin'),
            39 => $this->trans('The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form', array(), 'Modules.Autoupgrade.Admin'),
            40 => $this->trans('The uploaded file was only partially uploaded', array(), 'Modules.Autoupgrade.Admin'),
            41 => $this->trans('No file was uploaded.', array(), 'Modules.Autoupgrade.Admin'),
            42 => $this->trans('Missing a temporary folder', array(), 'Modules.Autoupgrade.Admin'),
            43 => $this->trans('Failed to write file to disk', array(), 'Modules.Autoupgrade.Admin'),
            44 => $this->trans('File upload stopped by extension', array(), 'Modules.Autoupgrade.Admin'),
            45 => $this->trans('Cannot convert your database\'s data to utf-8.', array(), 'Modules.Autoupgrade.Admin'),
            47 => $this->trans('Your firstname contains some invalid characters', array(), 'Install'),
            46 => $this->trans('Invalid shop name', array(), 'Install'),
            49 => $this->trans('Your database server does not support the utf-8 charset.', array(), 'Install'),
            50 => $this->trans('Your MySQL server does not support this engine, please use another one like MyISAM', array(), 'Modules.Autoupgrade.Admin'),
            48 => $this->trans('Your lastname contains some invalid characters', array(), 'Modules.Autoupgrade.Admin'),
            51 => $this->trans('The file /img/logo.jpg is not writable, please CHMOD 755 this file or CHMOD 777', array(), 'Modules.Autoupgrade.Admin'),
            52 => $this->trans('Invalid catalog mode', array(), 'Modules.Autoupgrade.Admin'),
            999 => $this->trans('No error code available', array(), 'Modules.Autoupgrade.Admin'),
            //upgrader
            27 => $this->trans('This installer is too old.', array(), 'Modules.Autoupgrade.Admin'),
            28 => $this->trans('You already have the %s version.', array($INSTALL_VERSION), 'Modules.Autoupgrade.Admin'),
            29 => $this->trans('There is no older version. Did you delete or rename the app/config/parameters.php file?', array(), 'Modules.Autoupgrade.Admin'),
            30 => $this->trans('The app/config/parameters.php file was not found. Did you delete or rename this file?', array(), 'Modules.Autoupgrade.Admin'),
            31 => $this->trans('Cannot find the SQL upgrade files. Please verify that the /install/upgrade/sql folder is not empty.', array(), 'Modules.Autoupgrade.Admin'),
            32 => $this->trans('No upgrade is possible.', array(), 'Modules.Autoupgrade.Admin'),
            33 => $this->trans('Error while loading SQL upgrade file.', array(), 'Modules.Autoupgrade.Admin'),
            34 => $this->trans('Error while inserting content into the database', array(), 'Modules.Autoupgrade.Admin'),
            35 => $this->trans('Unfortunately,', array(), 'Modules.Autoupgrade.Admin'),
            36 => $this->trans('SQL errors have occurred.', array(), 'Modules.Autoupgrade.Admin'),
            37 => $this->trans('The config/defines.inc.php file was not found. Where did you move it?', array(), 'Modules.Autoupgrade.Admin'),
        );
        return $ret;
    }
    ...
    {
        echo json_encode($this->buildAjaxResult());
    }
    ...
    public function display()
    {
        ...
        if (null === $kernel || !$kernel instanceof KernelInterface) {
            throw new Exception('Symfony kernel is not available');
        }
        $dependencyContainer = $kernel->getContainer();

        // set translator locale
        $translator = $dependencyContainer->get('translator');
        $locale = Context::getContext()->language->locale;
        $translator->setLocale($locale);

        // make the modules' templates discoverable by twig
        $twig = $dependencyContainer->get('twig');
        /** @var $twigLoader \Twig_Loader_Filesystem */
        $twigLoader = $twig->getLoader();
        if (!$twigLoader instanceof \Twig_Loader_Filesystem) {
            throw new Exception(sprintf('Unexpected Twig loader: "%s"', get_class($twigLoader)));
        }
        $twigLoader->addPath(realpath(__DIR__.'/views/templates'), 'ModuleAutoUpgrade');
    ...
    public function display2()
    {
        ...
        $this->_html .= '<script src="'.__PS_BASE_URI__.'modules/autoupgrade/js/jquery.xml2json.js"></script>' . PHP_EOL
            . '<script>var input = '.json_encode($this->_getJsInit()).';</script>'
            . '<script src="'.__PS_BASE_URI__.'modules/autoupgrade/js/upgrade.js"></script>';
    ...
    private function _getJsInit()
    {
        ...
        $jsParams = array(
            ...
            'PS_AUTOUP_BACKUP' => (bool) $this->getConfig('PS_AUTOUP_BACKUP'),
            'baseUri' => __PS_BASE_URI__,
            'adminDir' => $admin_dir,
            'token' => $this->token,
            'txtError' => $this->_getJsErrorMsgs(),
            'firstTimeParams' => $this->buildAjaxResult(),
            ...
            'channel' => $this->getConfig('channel'),
            'translation' => array(
                'confirmDeleteBackup' => $this->trans('Are you sure you want to delete this backup?', array(), 'Modules.Autoupgrade.Admin'),
                'delete' => $this->trans('Delete', array(), 'Admin.Actions'),
                'updateInProgress' => $this->trans('An update is currently in progress... Click "OK" to abort.', array(), 'Modules.Autoupgrade.Admin'),
                'upgradingPrestaShop' => $this->trans('Upgrading PrestaShop', array(), 'Modules.Autoupgrade.Admin'),
                'upgradeComplete' => $this->trans('Upgrade complete', array(), 'Modules.Autoupgrade.Admin'),
                'upgradeCompleteWithWarnings' => $this->trans('Upgrade complete, but warning notifications has been found.', array(), 'Modules.Autoupgrade.Admin'),
                'todoList' => array(
                ...
                'todoListTitle' => $this->trans('ToDo list:', array(), 'Modules.Autoupgrade.Admin'),
                'startingRestore' => $this->trans('Starting restoration...', array(), 'Modules.Autoupgrade.Admin'),
                'restoreComplete' => $this->trans('Restoration complete.', array(), 'Modules.Autoupgrade.Admin'),
                'cannotDownloadFile' => $this->trans('Your server cannot download the file. Please upload it first by ftp in your admin/autoupgrade directory', array(), 'Modules.Autoupgrade.Admin'),
                'jsonParseErrorForAction' => $this->trans('Javascript error (parseJSON) detected for action ', array(), 'Modules.Autoupgrade.Admin'),
                'manuallyGoToButton' => $this->trans('Manually go to %s button', array(), 'Modules.Autoupgrade.Admin'),
                'endOfProcess' => $this->trans('End of process', array(), 'Modules.Autoupgrade.Admin'),
                'processCancelledCheckForRestore' => $this->trans('Operation canceled. Checking for restoration...', array(), 'Modules.Autoupgrade.Admin'),
                'confirmRestoreBackup' => $this->trans('Do you want to restore %s?', array($this->backupName), 'Modules.Autoupgrade.Admin'),
                'processCancelledWithError' => $this->trans('Operation canceled. An error happened.', array(), 'Modules.Autoupgrade.Admin'),
                'missingAjaxUpgradeTab' => $this->trans('[TECHNICAL ERROR] ajax-upgradetab.php is missing. please reinstall the module', array(), 'Modules.Autoupgrade.Admin'),
                'clickToRefreshAndUseNewConfiguration' => $this->trans('Click to refresh the page and use the new configuration', array(), 'Modules.Autoupgrade.Admin'),
                'errorDetectedDuring' => $this->trans('Error detected during', array(), 'Modules.Autoupgrade.Admin'),
                'downloadTimeout' => $this->trans('The request exceeded the max_time_limit. Please change your server configuration.', array(), 'Modules.Autoupgrade.Admin'),
                'seeOrHideList' => $this->trans('See or hide the list', array(), 'Modules.Autoupgrade.Admin'),
                'coreFiles' => $this->trans('Core file(s)', array(), 'Modules.Autoupgrade.Admin'),
                'mailFiles' => $this->trans('Mail file(s)', array(), 'Modules.Autoupgrade.Admin'),
                'translationFiles' => $this->trans('Translation file(s)', array(), 'Modules.Autoupgrade.Admin'),
                'linkAndMd5CannotBeEmpty' => $this->trans('Link and MD5 hash cannot be empty', array(), 'Modules.Autoupgrade.Admin'),
                'needToEnterArchiveVersionNumber' => $this->trans('You need to enter the version number associated with the archive.', array(), 'Modules.Autoupgrade.Admin'),
                'noArchiveSelected' => $this->trans('No archive has been selected.', array(), 'Modules.Autoupgrade.Admin'),
                'needToEnterDirectoryVersionNumber' => $this->trans('You need to enter the version number associated with the directory.', array(), 'Modules.Autoupgrade.Admin'),
                'confirmSkipBackup' => $this->trans('Please confirm that you want to skip the backup.', array(), 'Modules.Autoupgrade.Admin'),
                'confirmPreserveFileOptions' => $this->trans('Please confirm that you want to preserve file options.', array(), 'Modules.Autoupgrade.Admin'),
                'lessOptions' => $this->trans('Less options', array(), 'Modules.Autoupgrade.Admin'),
                'moreOptions' => $this->trans('More options (Expert mode)', array(), 'Modules.Autoupgrade.Admin'),
                'filesWillBeDeleted' => $this->trans('Theses files will be deleted', array(), 'Modules.Autoupgrade.Admin'),
            )
        );
